 ...
 */
public class WLTaskLocalServiceClp implements WLTaskLocalService {
	public WLTaskLocalServiceClp(InvokableLocalService invokableLocalService) {
	...
	public com.jenginetest.builder.model.WLTask addWLTask(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(wlTask) });
		}
		catch (Throwable t) {
		...
		return (com.jenginetest.builder.model.WLTask)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<com.jenginetest.builder.model.WLTask> getWLTasks(
		...
		return (java.util.List<com.jenginetest.builder.model.WLTask>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public com.jenginetest.builder.model.WLTask updateWLTask(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName15,
					...
					new Object[] { ClpSerializer.translateInput(wlTask), merge });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
