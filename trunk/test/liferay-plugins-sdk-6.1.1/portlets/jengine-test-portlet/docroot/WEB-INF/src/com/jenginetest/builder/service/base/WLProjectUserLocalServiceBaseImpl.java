...
/**
 * The base implementation of the w l project user local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.jenginetest.builder.service.impl.WLProjectUserLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class WLProjectUserLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements WLProjectUserLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.jenginetest.builder.service.WLProjectUserLocalServiceUtil} to access the w l project user local service.
	 */
	...
	public WLProjectUser addWLProjectUser(WLProjectUser wlProjectUser)
		throws SystemException {
		wlProjectUser.setNew(true);

		return wlProjectUserPersistence.update(wlProjectUser, false);
	}
	 ...
	 */
	public WLProjectUser createWLProjectUser(long projectUserId) {
		return wlProjectUserPersistence.create(projectUserId);
	}
	...
	public WLProjectUser deleteWLProjectUser(long projectUserId)
		throws PortalException, SystemException {
		return wlProjectUserPersistence.remove(projectUserId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public WLProjectUser deleteWLProjectUser(WLProjectUser wlProjectUser)
		throws SystemException {
		return wlProjectUserPersistence.remove(wlProjectUser);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(WLProjectUser.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return wlProjectUserPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return wlProjectUserPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public WLProjectUser fetchWLProjectUser(long projectUserId)
		throws SystemException {
		return wlProjectUserPersistence.fetchByPrimaryKey(projectUserId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public WLProjectUser getWLProjectUser(long projectUserId)
		throws PortalException, SystemException {
		return wlProjectUserPersistence.findByPrimaryKey(projectUserId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return wlProjectUserPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<WLProjectUser> getWLProjectUsers(int start, int end)
		throws SystemException {
		return wlProjectUserPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getWLProjectUsersCount() throws SystemException {
		return wlProjectUserPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public WLProjectUser updateWLProjectUser(WLProjectUser wlProjectUser)
		throws SystemException {
		return updateWLProjectUser(wlProjectUser, true);
	}
	...
	public WLProjectUser updateWLProjectUser(WLProjectUser wlProjectUser,
		...
		return wlProjectUserPersistence.update(wlProjectUser, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.jenginetest.builder.model.WLProjectUser",
			wlProjectUserLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = wlProjectUserPersistence.getDataSource();
	...
	private WLProjectUserLocalServiceClpInvoker _clpInvoker = new WLProjectUserLocalServiceClpInvoker();
}