...
/**
 * The base implementation of the w l project local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.jenginetest.builder.service.impl.WLProjectLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class WLProjectLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements WLProjectLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.jenginetest.builder.service.WLProjectLocalServiceUtil} to access the w l project local service.
	 */
	...
	public WLProject addWLProject(WLProject wlProject)
		throws SystemException {
		wlProject.setNew(true);

		return wlProjectPersistence.update(wlProject, false);
	}
	 ...
	 */
	public WLProject createWLProject(long projectId) {
		return wlProjectPersistence.create(projectId);
	}
	...
	public WLProject deleteWLProject(long projectId)
		throws PortalException, SystemException {
		return wlProjectPersistence.remove(projectId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public WLProject deleteWLProject(WLProject wlProject)
		throws SystemException {
		return wlProjectPersistence.remove(wlProject);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(WLProject.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return wlProjectPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return wlProjectPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return wlProjectPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public WLProject fetchWLProject(long projectId) throws SystemException {
		return wlProjectPersistence.fetchByPrimaryKey(projectId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public WLProject getWLProject(long projectId)
		throws PortalException, SystemException {
		return wlProjectPersistence.findByPrimaryKey(projectId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return wlProjectPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<WLProject> getWLProjects(int start, int end)
		throws SystemException {
		return wlProjectPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getWLProjectsCount() throws SystemException {
		return wlProjectPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public WLProject updateWLProject(WLProject wlProject)
		throws SystemException {
		return updateWLProject(wlProject, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public WLProject updateWLProject(WLProject wlProject, boolean merge)
		throws SystemException {
		wlProject.setNew(false);

		return wlProjectPersistence.update(wlProject, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.jenginetest.builder.model.WLProject",
			wlProjectLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = wlProjectPersistence.getDataSource();
	...
	private WLProjectLocalServiceClpInvoker _clpInvoker = new WLProjectLocalServiceClpInvoker();
}