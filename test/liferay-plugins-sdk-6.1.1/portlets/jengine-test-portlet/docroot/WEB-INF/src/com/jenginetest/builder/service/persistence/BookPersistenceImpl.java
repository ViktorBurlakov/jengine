...
import com.jenginetest.builder.NoSuchBookException;
import com.jenginetest.builder.model.Book;
import com.jenginetest.builder.model.impl.BookImpl;
import com.jenginetest.builder.model.impl.BookModelImpl;
...
public class BookPersistenceImpl extends BasePersistenceImpl<Book>
	...
	@Override
	public Book updateImpl(com.jenginetest.builder.model.Book book,
	...
	protected Book toUnwrappedModel(Book book) {
		...
		bookImpl.setLibraryId(book.getLibraryId());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.jenginetest.builder.model.Book")));
