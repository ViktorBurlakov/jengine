...
/**
 * The base implementation of the library local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.jenginetest.builder.service.impl.LibraryLocalServiceImpl}.
 * </p>
 *
...
public abstract class LibraryLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements LibraryLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.jenginetest.builder.service.LibraryLocalServiceUtil} to access the library local service.
	 */
	...
	public Library addLibrary(Library library) throws SystemException {
		library.setNew(true);

		return libraryPersistence.update(library, false);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Library deleteLibrary(Library library) throws SystemException {
	...
	public Library fetchLibrary(long libraryId) throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getLibrariesCount() throws SystemException {
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Library updateLibrary(Library library) throws SystemException {
		return updateLibrary(library, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Library updateLibrary(Library library, boolean merge)
		throws SystemException {
		library.setNew(false);

		return libraryPersistence.update(library, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.jenginetest.builder.model.Library",
			libraryLocalService);
	}
	...
	private LibraryLocalServiceClpInvoker _clpInvoker = new LibraryLocalServiceClpInvoker();
}