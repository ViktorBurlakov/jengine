...
/**
 * The base implementation of the member local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.jenginetest.builder.service.impl.MemberLocalServiceImpl}.
 * </p>
 *
...
public abstract class MemberLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.jenginetest.builder.service.MemberLocalServiceUtil} to access the member local service.
	 */
	...
	public Member addMember(Member member) throws SystemException {
		...
		return memberPersistence.update(member, false);
	}
	...
	public Member updateMember(Member member) throws SystemException {
		return updateMember(member, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Member updateMember(Member member, boolean merge)
		throws SystemException {
		member.setNew(false);

		return memberPersistence.update(member, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.jenginetest.builder.model.Member",
			memberLocalService);
	}
