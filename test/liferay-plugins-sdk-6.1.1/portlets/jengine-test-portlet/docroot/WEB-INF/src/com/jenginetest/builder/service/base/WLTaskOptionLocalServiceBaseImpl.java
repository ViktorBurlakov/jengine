...
/**
 * The base implementation of the w l task option local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.jenginetest.builder.service.impl.WLTaskOptionLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class WLTaskOptionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements WLTaskOptionLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.jenginetest.builder.service.WLTaskOptionLocalServiceUtil} to access the w l task option local service.
	 */
	...
	public WLTaskOption addWLTaskOption(WLTaskOption wlTaskOption)
		throws SystemException {
		wlTaskOption.setNew(true);

		return wlTaskOptionPersistence.update(wlTaskOption, false);
	}
	 ...
	 */
	public WLTaskOption createWLTaskOption(long optionId) {
		return wlTaskOptionPersistence.create(optionId);
	}
	...
	public WLTaskOption deleteWLTaskOption(long optionId)
		throws PortalException, SystemException {
		return wlTaskOptionPersistence.remove(optionId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public WLTaskOption deleteWLTaskOption(WLTaskOption wlTaskOption)
		throws SystemException {
		return wlTaskOptionPersistence.remove(wlTaskOption);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(WLTaskOption.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return wlTaskOptionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return wlTaskOptionPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public WLTaskOption fetchWLTaskOption(long optionId)
		throws SystemException {
		return wlTaskOptionPersistence.fetchByPrimaryKey(optionId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public WLTaskOption getWLTaskOption(long optionId)
		throws PortalException, SystemException {
		return wlTaskOptionPersistence.findByPrimaryKey(optionId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return wlTaskOptionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<WLTaskOption> getWLTaskOptions(int start, int end)
		throws SystemException {
		return wlTaskOptionPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getWLTaskOptionsCount() throws SystemException {
		return wlTaskOptionPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public WLTaskOption updateWLTaskOption(WLTaskOption wlTaskOption)
		throws SystemException {
		return updateWLTaskOption(wlTaskOption, true);
	}
	...
	public WLTaskOption updateWLTaskOption(WLTaskOption wlTaskOption,
		...
		return wlTaskOptionPersistence.update(wlTaskOption, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.jenginetest.builder.model.WLTaskOption",
			wlTaskOptionLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = wlTaskOptionPersistence.getDataSource();
	...
	private WLTaskOptionLocalServiceClpInvoker _clpInvoker = new WLTaskOptionLocalServiceClpInvoker();
}